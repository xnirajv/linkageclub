...
export default function AssessmentResultsPage() {
  ...
  // ✅ SAFE CHECK: Agar results structure sahi nahi hai
  if (!results.results || !results.results.questions || results.results.questions.length === 0) {
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center">
          <p className="text-charcoal-600">No results found. Please complete the assessment first.</p>
          <Button className="mt-4" onClick={() => window.location.href = '/dashboard/student/assessments'}>
            Go Back
          </Button>
        </div>
      </div>
