...
export function Header({ className }: HeaderProps) {
  ...
  return (
    <header className={cn(
      'sticky top-0 z-30 h-14 border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-sm flex items-center justify-between px-6',
      className
    )}>
