...
export function PopularSection({ assessments }: { assessments: PopularAssessment[] }) {
  return (
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-2">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-sm text-gray-500">({formatNumber(assessment.ratingCount)} ratings)</span>
                </div>
                <div className="flex items-center gap-1 text-gray-500">
                  <Users className="h-3 w-3" />
                  <span className="text-sm">{formatNumber(assessment.takenCount)} taken</span>
                </div>
              </div>
              ...
              <p className="text-xs text-gray-400 mt-2">
                {assessment.takenCount > 5000 ? '🚀 High demand skill' : '📈 Growing demand'}
              </p>
            </div>
