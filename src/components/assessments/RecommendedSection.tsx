...
export function RecommendedSection({ assessments }: { assessments: RecommendedAssessment[] }) {
  return (
              ...
              <div className="flex items-center gap-3 text-sm">
                {assessment.badgeName && (
                  <div className="flex items-center gap-1 text-yellow-600">
                    ...
                    <span>Badge: {assessment.badgeName}</span>
                  </div>
                )}
                {assessment.trustBoost > 0 && (
                  <div className="flex items-center gap-1 text-green-600">
                    <TrendingUp className="h-4 w-4" />
                    <span>Trust Score +{assessment.trustBoost}</span>
                  </div>
                )}
              </div>
            </div>
